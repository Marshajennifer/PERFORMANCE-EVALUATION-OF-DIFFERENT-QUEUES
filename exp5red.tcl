...
set tracefile [open exp5red.tr w]
$ns trace-all $tracefile
set namfile [open exp5red.nam w]
...
$ns duplex-link $n2 $n3 3Mb 10ms RED
$ns duplex-link $n6 $n2 1Mb 10ms RED
$ns duplex-link $n1 $n2 1Mb 10ms RED
$ns duplex-link $n3 $n5 2Mb 10ms RED
$ns duplex-link $n3 $n7 2Mb 10ms RED
...
proc finish {} {
	...
	close $tracefile
	close $namfile
	exec nam exp5red.nam &
	exec awk -f exp5all.awk exp5red.tr > outputred.tr &
	exit 0
}
