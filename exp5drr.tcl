...
set tracefile [open exp5drr.tr w]
$ns trace-all $tracefile
set namfile [open exp5drr.nam w]
...
$ns duplex-link $n2 $n3 3Mb 10ms DRR
$ns duplex-link $n6 $n2 1Mb 10ms DRR
$ns duplex-link $n1 $n2 1Mb 10ms DRR
$ns duplex-link $n3 $n5 2Mb 10ms DRR
$ns duplex-link $n3 $n7 2Mb 10ms DRR
$ns duplex-link $n3 $n4 2Mb 10ms DRR
...
proc finish {} {
	...
	close $tracefile
	close $namfile
	exec nam exp5drr.nam &
	exec awk -f exp5all.awk exp5drr.tr > outputdrr.tr &
	exit 0
}
