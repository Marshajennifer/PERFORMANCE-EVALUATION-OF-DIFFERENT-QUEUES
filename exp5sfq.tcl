...
set tracefile [open exp5sfq.tr w]
$ns trace-all $tracefile
set namfile [open exp5sfq.nam w]
...
$ns duplex-link $n6 $n2 1Mb 10ms SFQ
$ns duplex-link $n1 $n2 1Mb 10ms SFQ
$ns duplex-link $n3 $n5 2Mb 10ms SFQ
$ns duplex-link $n3 $n7 2Mb 10ms SFQ
$ns duplex-link $n3 $n4 2Mb 10ms SFQ
...
proc finish {} {
	...
	close $tracefile
	close $namfile
	exec nam exp5sfq.nam &
	exec awk -f exp5all.awk exp5sfq.tr > outputsfq.tr &
	exit 0
}
